...
function ss_slb_rserver($hostname, $host_id, $snmp_auth, $cmd, $arg1 = "", $arg2 = "") {
	...
	if ($cmd == "get") {
		...
		$index_array = slb_rindex(cacti_snmp_walk($hostname, $snmp_community, $oids["State"], $snmp_version, $snmp_auth_username, $snmp_auth_password, $snmp_auth_protocol, $snmp_priv_passphrase, $snmp_priv_protocol, $snmp_context, $snmp_port, $snmp_timeout, read_config_option("snmp_retries"), SNMP_POLLER));
